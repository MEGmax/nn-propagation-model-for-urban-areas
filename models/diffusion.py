...
class Diffusion:
    ...
    def p_losses(self, x_start: torch.Tensor, cond_img: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        noise = torch.randn_like(x_start)
...
class RadioMapDataset(Dataset):
    def __init__(self, input_dir: str | os.PathLike[str], target_dir: str | os.PathLike[str]):
        super().__init__()
